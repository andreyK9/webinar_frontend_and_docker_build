export const auth = {
  ...
  'confirm mail error description':
    'Вы не смогли подтвердить email, данный аккаунт заблокирован. Обратитесь в Службу поддержки клиентов support@esplanade-ms.com или напишите в LiveChat.',
  'sign in form checkbox': 'Запомнить данные для повторного входа',
  'problem message':
    'Если у Вас возникли проблемы обратитесь в службу поддержки клиентов support@esplanade-ms.com или напишите в LiveChat',
  'personal Agree':
    'Я даю согласие на обработку своих персональных данных и подтверждаю, что ознакомился и принимаю условия Клиентское соглашение и всех Регламентирующих документов, являющихся его неотъемлемой частью.',
  'ok button': 'Ok',
  'submit button': 'Войти',
